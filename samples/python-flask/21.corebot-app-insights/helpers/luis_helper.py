...
class LuisHelper:
    ...
    @staticmethod
    async def execute_luis_query(configuration, turn_context: TurnContext,
                                 telemetry_client: BotTelemetryClient = None) -> BookingDetails:
        ...
        try:
            ...
            options.telemetry_client = telemetry_client if telemetry_client is not None else NullTelemetryClient()
