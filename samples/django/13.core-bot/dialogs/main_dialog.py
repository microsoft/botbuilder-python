...
class MainDialog(ComponentDialog):
    ...
    def __init__(self, configuration: dict, dialog_id: str = None):
        ...
        self._configuration = config.DefaultConfig
    ...
    async def intro_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        if (not self._configuration.LUIS_APP_ID or not self._configuration.LUIS_API_KEY or not self._configuration.LUIS_API_HOST_NAME):
    ...
    async def act_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        booking_details = await LuisHelper.execute_luis_query(self._configuration, step_context.context) if step_context.result is not None else BookingDetails()
