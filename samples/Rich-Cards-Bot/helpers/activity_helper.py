...
from botbuilder.schema import Activity, ActivityTypes, Attachment, ChannelAccount, ConversationAccount

def create_activity_reply(activity: Activity, text: str = None, locale: str = None, attachments: [Attachment] = []):
