...
import msrest
from microsoft.bot.connector import BotConnector
from microsoft.bot.connector import customs
from microsoft.bot.connector import models
from microsoft.bot.connector.customs.auth import MicrosoftTokenAuthentication
...
def get_auth_token():
    try:
        ...
        return customs.MicrosoftTokenAuthentication(app_creds_real.MICROSOFT_APP_ID, app_creds_real.MICROSOFT_APP_PASSWORD).get_accessToken()
    except ImportError:
