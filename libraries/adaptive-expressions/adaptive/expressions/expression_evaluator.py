...
EvaluateExpressionDelegate = NewType(
    "EvaluateExpressionDelegate", Callable[[object, MemoryInterface, Options], object]
)

ValidateExpressionDelegate = NewType(
    "ValidateExpressionDelegate", Callable[[object], object]
)
...
class ExpressionEvaluator:
    ...
    def try_evaluate(
        self, expression: object, state: MemoryInterface, options: Options
    ):
