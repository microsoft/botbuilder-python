...
from ..expression_type import YEAR
from ..function_utils import FunctionUtils
from ..return_type import ReturnType


class Year(ExpressionEvaluator):
    def __init__(self):
        super().__init__(
            YEAR, Year.evaluator(), ReturnType.Number, FunctionUtils.validate_unary
        )
