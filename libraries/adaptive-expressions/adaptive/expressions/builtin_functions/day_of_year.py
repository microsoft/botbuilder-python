...
from ..expression_type import DAYOFYEAR
from ..function_utils import FunctionUtils
from ..return_type import ReturnType

class DayOfYear(ExpressionEvaluator):
    def __init__(self):
        super().__init__(
            DAYOFYEAR, DayOfYear.evaluator(), ReturnType.Number, FunctionUtils.validate_unary
        )
    ...
    def evaluator() -> EvaluateExpressionDelegate:
        def anonymous_function(args: list):
            def anonymous_func(date_time: datetime):
                return date_time.timetuple().tm_yday, None
