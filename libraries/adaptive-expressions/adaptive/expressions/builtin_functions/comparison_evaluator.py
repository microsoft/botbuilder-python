...
from ..expression_evaluator import ExpressionEvaluator, EvaluateExpressionDelegate, ValidateExpressionDelegate
...
class ComparisonEvaluator(ExpressionEvaluator):
    ...
    def __init__(
        ...
        super().__init__(expr_type, ComparisonEvaluator.evaluator(func, verify), ReturnType.Boolean, validator)

    @staticmethod
    def evaluator(func: Callable[[list], bool], verify: FunctionUtils.verify_expression) -> EvaluateExpressionDelegate:
