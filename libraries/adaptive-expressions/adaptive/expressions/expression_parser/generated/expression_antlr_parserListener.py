...
class expression_antlr_parserListener(ParseTreeListener):
    ...
    def enterStringInterpolationAtom(self, ctx:expression_antlr_parser.StringInterpolationAtomContext):
        pass

    # Exit a parse tree produced by expression_antlr_parser#stringInterpolationAtom.
    def exitStringInterpolationAtom(self, ctx:expression_antlr_parser.StringInterpolationAtomContext):
        pass
    ...
    def enterArrayCreationExp(self, ctx:expression_antlr_parser.ArrayCreationExpContext):
        pass

    # Exit a parse tree produced by expression_antlr_parser#arrayCreationExp.
    def exitArrayCreationExp(self, ctx:expression_antlr_parser.ArrayCreationExpContext):
        pass


    # Enter a parse tree produced by expression_antlr_parser#stringInterpolation.
    def enterStringInterpolation(self, ctx:expression_antlr_parser.StringInterpolationContext):
        pass

    # Exit a parse tree produced by expression_antlr_parser#stringInterpolation.
    def exitStringInterpolation(self, ctx:expression_antlr_parser.StringInterpolationContext):
        pass
    ...
    def enterKeyValuePairList(self, ctx:expression_antlr_parser.KeyValuePairListContext):
        pass

    # Exit a parse tree produced by expression_antlr_parser#keyValuePairList.
    def exitKeyValuePairList(self, ctx:expression_antlr_parser.KeyValuePairListContext):
        pass
