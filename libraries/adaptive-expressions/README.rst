...
=================================
Adaptive-Expression SDK for Python
=================================
...
.. image:: https://badge.fury.io/py/adaptive-expressions.svg
   :target: https://badge.fury.io/py/adaptive-expressions
   :alt: Latest PyPI package version

Adaptive expressions for Microsoft BotBuilder.
...
.. code-block:: python
  ...
  pip install adaptive-expressions
