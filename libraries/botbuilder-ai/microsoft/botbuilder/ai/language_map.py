...
class LanguageMap:
    ...
    def __init__(self):
        ...
        self.add("ca", "Catalan")
        self.add("zh-CHS", "Chinese Simplified")
        self.add("zh-CHT", "Chinese Traditional")
        self.names_to_names["Chinese"] = ["Simplified", "Traditional"]

        self.add("hr", "Croatian")
        self.add("cs", "Czech")
        self.add("da", "Danish")
        self.add("nl", "Dutch")
        self.add("en", "English")
        self.add("et", "Estonian")
        self.add("fi", "Finnish")
        self.add("fr", "French")
        self.add("de", "German")

        self.add("el", "Greek")
        self.add("ht", "Haitian Creole")
        self.names_to_codes["Creole"] = "ht"
        self.add("he", "Hebrew")
        self.add("hi", "Hindi")
        self.add("mww", "Hmong Daw")
        self.names_to_codes["Hmong"] = "mww"
        self.names_to_codes["Daw"] = "mww"

        self.add("hu", "Hungarian")
        self.add("id", "Indonesian")
        self.add("it", "Italian")
        self.add("ja", "Japanese")
        self.add("sw", "Kiswahili")
        self.add("ko", "Korean")
        self.add("tlh", "Klingon")
        self.add("lv", "Latvian")
        self.add("lt", "Lithuanian")
        self.add("ms", "Malay")
        self.add("mt", "Maltese")
        self.add("no", "Norwegian")
        self.add("fa", "Persian")
        self.add("pl", "Polish")
        self.add("pt", "Portuguese")
        self.add("otq", "Querétaro Otomi")
        self.names_to_codes["Querétaro"] = "otq"
        self.names_to_codes["Otomi"] = "otq"

        self.add("ro", "Romanian")
        self.add("ru", "Russian")
        self.add("sr-Cyrl", "Serbian Cyrillic")
        self.add("sr-Latn", "Serbian Latin")
        self.names_to_names["Serbian"] = [{"Cyrillic", "Latin"}]

        self.add("sk", "Slovak")
        self.add("sl", "Slovenian")
        self.add("es", "Spanish")
        self.add("sv", "Swedish")
        self.add("th", "Thai")
        self.add("tr", "Turkish")
        self.add("uk", "Ukrainian")
        self.add("ur", "Urdu")
        self.add("vi", "Vietnamese")
        self.add("cy", "Welsh")
        self.add("yua", "Yucatec Maya")
        self.names_to_codes["yucatec"] = "yua"
        self.names_to_codes["maya"] = "yua"

    def add(self, code: str, name: str):
        self.codes_to_names[code] = name
        self.names_to_codes[name] = code

    def get_code_for_input(self, values):
        for val in values:
            if val in self.names_to_codes:
                return val
            if val in self.names_to_names:
                for name in self.names_to_names[val]:
                    second_val = values[val]
                    if second_val:
                        return self.try_compound(val, second_val)
        return None

    def get_code_or_fall_back(self, code: str):
    ...
    def try_compound(self, first_val:str, second_val:str):
        compound = "{} {}".format(first_val, second_val)
        if self.names_to_codes.get(self, compound):
            return True
        compound =  "{} {}".format(second_val, first_val)
        if self.names_to_codes.get(self, compound):
            return True
        return False
