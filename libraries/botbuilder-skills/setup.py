...
with open(os.path.join(root, "botbuilder", "skills", "about.py")) as f:
    package_info = {}
    info = f.read()
...
setup(
    ...
    keywords=["BotBuilderSkills", "bots", "ai", "botframework", "botbuilder"],
    long_description=long_description,
    long_description_content_type="text/x-rst",
    license=package_info["__license__"],
    packages=["botbuilder.skills", "botbuilder.skills.adapters"],
