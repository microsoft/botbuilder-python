...
class PredictionOperations(object):
    ...
    def resolve2(
        ...
        :rtype: ~luisruntime.models.LuisResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`APIErrorException<luisruntime.models.APIErrorException>`
        """
        # Construct URL
        url = '/{appId}'
        ...
        query_parameters = {}
        query_parameters['q'] = self._serialize.query("query", query, 'str', max_length=500)
