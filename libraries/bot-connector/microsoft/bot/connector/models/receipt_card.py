...
class ReceiptCard(Model):
    ...
    :type items: list[~bot.connector.models.ReceiptItem]
    :param facts: Array of Fact Objects   Array of key-value pairs.
    :type facts: list[~bot.connector.models.Fact]
    :param tap: This action will be activated when user taps on the card
    :type tap: ~bot.connector.models.CardAction
    ...
    :type buttons: list[~bot.connector.models.CardAction]
    """
