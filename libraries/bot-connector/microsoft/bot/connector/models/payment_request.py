...
class PaymentRequest(Model):
    ...
    :type method_data: list[~bot.connector.models.PaymentMethodData]
    :param details: Details for this request
    :type details: ~bot.connector.models.PaymentDetails
    :param options: Provides information about the options desired for the
     payment request
    :type options: ~bot.connector.models.PaymentOptions
