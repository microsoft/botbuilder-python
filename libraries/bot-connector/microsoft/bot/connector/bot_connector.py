...
class BotConnectorConfiguration(Configuration):
    """Configuration for BotConnector
    ...
    def __init__(
        ...
        super(BotConnectorConfiguration, self).__init__(base_url)

        self.add_user_agent('bot-connector/{}'.format(VERSION))
...
class BotConnector(object):
    ...
    * Generate your own from the [Connector API Swagger file](https://raw.githubusercontent.com/Microsoft/BotBuilder/master/CSharp/Library/Microsoft.Bot.Connector.Shared/Swagger/ConnectorAPI.json)
    ...
    :vartype config: BotConnectorConfiguration

    :ivar attachments: Attachments operations
    :vartype attachments: bot.connector.operations.AttachmentsOperations
    :ivar conversations: Conversations operations
    :vartype conversations: bot.connector.operations.ConversationsOperations
    ...
    def __init__(
        ...
        self.config = BotConnectorConfiguration(credentials, base_url)
