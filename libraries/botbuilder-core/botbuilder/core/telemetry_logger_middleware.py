...
class TelemetryLoggerMiddleware(Middleware):
    ...
    async def on_process_request(self, context: TurnContext,
        ...
        async def send_activities_handler(ctx: TurnContext, activities: List[Activity],
        ...
        async def update_activity_handler(ctx: TurnContext, activity: Activity,
                                          next_update: Callable[[], Awaitable]):
            # Run full pipeline
        ...
        async def delete_activity_handler(ctx: TurnContext, reference: ConversationReference,
    ...
    async def on_receive_activity(self, activity: Activity) -> None:
        ...
        """
        self.telemetry_client.track_event(TelemetryLoggerConstants.BOT_MSG_RECEIVE_EVENT,
    ...
    async def on_send_activity(self, activity: Activity) -> None:
        ...
        """
        self.telemetry_client.track_event(TelemetryLoggerConstants.BOT_MSG_SEND_EVENT,
    ...
    async def on_update_activity(self, activity: Activity) -> None:
        ...
        :param activity: Current activity sent from user.
        """
        self.telemetry_client.track_event(TelemetryLoggerConstants.BOT_MSG_UPDATE_EVENT,
    ...
    async def on_delete_activity(self, activity: Activity) -> None:
        ...
        :param activity: Current activity sent from user.
        """
        self.telemetry_client.track_event(TelemetryLoggerConstants.BOT_MSG_DELETE_EVENT,
    ...
    async def fill_update_event_properties(self, activity: Activity,
                                           additional_properties: Dict[str, str] = None) -> Dict[str, str]:
