...
class InspectionSessionsByStatus(Model):
    _attribute_map = {
        ...
        "attached_sessions": {"key": "attachedSessions", "type": "{ConversationReference}"},
    }

    def __init__(
        self,
        opened_sessions: Dict[str, ConversationReference] = {},
        attached_sessions: Dict[str, ConversationReference] = {},
        **kwargs
    ):
        super(InspectionSessionsByStatus, self).__init__(**kwargs)
        self.opened_sessions: Dict[str, ConversationReference] = opened_sessions
        self.attached_sessions: Dict[str, ConversationReference] = attached_sessions
