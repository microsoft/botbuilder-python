...
class TestingTeamsActivityHandler(TeamsActivityHandler):
    ...
    async def on_teams_file_consent(self, turn_context: TurnContext, file_consent_card_response: FileConsentCardResponse):
        self.record.append("on_teams_file_consent")
        return await super().on_teams_file_consent(turn_context, file_consent_card_response)
    ...
    async def on_teams_messaging_extension_submit_action_dispatch(
        ...
        return await super().on_teams_messaging_extension_submit_action_dispatch(turn_context, action)
    ...
    async def on_teams_messaging_extension_submit_action_activity(
        ...
        return await super().on_teams_messaging_extension_submit_action_activity(turn_context, action)

    async def on_teams_messaging_extension_bot_message_preview_edit_activity(
        self, turn_context: TurnContext, action: MessagingExtensionAction
    ):
        self.record.append("on_teams_messaging_extension_bot_message_preview_edit_activity")
        return await super().on_teams_messaging_extension_bot_message_preview_edit_activity(turn_context, action)
    ...
    async def on_teams_messaging_extension_bot_message_send_activity(
        ...
        return await super().on_teams_messaging_extension_bot_message_send_activity(turn_context, action)

    async def on_teams_messaging_extension_fetch_task(
        self, turn_context: TurnContext, action: MessagingExtensionAction
    ):
        self.record.append("on_teams_messaging_extension_fetch_task")
        return await super().on_teams_messaging_extension_fetch_task(turn_context, action)

    async def on_teams_messaging_extension_configuration_query_settings_url(
        self, turn_context: TurnContext, query: MessagingExtensionQuery
    ):
        self.record.append("on_teams_messaging_extension_configuration_query_settings_url")
        return await super().on_teams_messaging_extension_configuration_query_settings_url(turn_context, query)
    ...
    async def on_teams_messaging_extension_configuration_setting(
        ...
        return await super().on_teams_messaging_extension_configuration_setting(turn_context, settings)
    ...
    async def on_teams_messaging_extension_card_button_clicked(
        ...
        return await super().on_teams_messaging_extension_card_button_clicked(turn_context, card_data)
    ...
    async def on_teams_task_module_submit(  # pylint: disable=unused-argument
        ...
        return await super().on_teams_task_module_submit(turn_context, task_module_request)
...
class TestTeamsActivityHandler(aiounittest.AsyncTestCase):
    ...
    async def test_on_teams_messaging_extension_bot_message_send_activity_with_none(self):
        # Arrange 
        activity = Activity(
                    type = ActivityTypes.invoke,
                    name = "composeExtension/submitAction",
    ...
    async def test_on_teams_messaging_extension_bot_message_send_activity_with_empty_string(self):
        # Arrange 
        activity = Activity(
                    type = ActivityTypes.invoke,
                    name = "composeExtension/submitAction",
