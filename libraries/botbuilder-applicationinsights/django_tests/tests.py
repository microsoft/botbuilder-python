...
class MiddlewareTests(AITestCase):
    ...
    def test_bot_event(self):
        ...
        self.assertEqual(logev['name'], 'Microsoft.ApplicationInsights.Event', "Event type")
    ...
    def test_401_success(self):
        ...
        data = event['data']['baseData']
        self.assertEqual(event['name'], 'Microsoft.ApplicationInsights.Request', "Event type")
        self.assertEqual(tags['ai.operation.name'], 'POST /returncode/405', "Operation name")
    ...
    def invoke_post(self, first_level_directory: str):
        ...
        return client.post(f'http://localhost/{first_level_directory}', json={
                                "type": "message",
                                "id": "bf3cc9a2f5de...",
