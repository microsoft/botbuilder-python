...
class ComponentDialog(Dialog):
    ...
    async def begin_dialog(
        self, outer_dc: DialogContext, options: object = None
    ) -> DialogTurnResult:
        if outer_dc is None:
    ...
    async def resume_dialog(
        self, outer_dc: DialogContext, reason: DialogReason, result: object = None
    ) -> DialogTurnResult:
    ...
    async def end_component(
        self, outer_dc: DialogContext, result: object
    ) -> DialogTurnResult:
