...
class OAuthPrompt(Dialog):
    ...
    def __init__(
        ...
        :type dialogId: str
        :param settings: Additional OAuth settings to use with this instance of the prompt.
        :type settings: :class:OAuthPromptSettings
        :param validator: Optional, a `PromptValidator{FoundChoice}` that contains additional, custom validation for this prompt.
        :type validator: `Callable[[PromptValidatorContext], Awaitable[bool]]`

        .. remarks::
            The value of :param dialogId: must be unique within the `DialogSet`or `ComponentDialog` to which the prompt is added.
        """
