...
class DialogTurnResult:
    """
    Result returned to the caller of one of the stack manipulation methods.
    ...
    def result(self):
        ...
        .. remarks::
            ...
            This will only be populated in certain cases:
                ...
                * The bot calls :meth:`DialogContext.continue_dialog()` and a
                dialog that was active ends.

        :return self._result: Result returned by a dialog that just completed.
